        ...
        { !isLoading && <div>
          ...
          <div>
            ...
            <form className='loginform'>
              ...
              <div className="form-group">
                <input type="name" className="form-control" placeholder="Enter first name" onChange={firstNameEntered} />
              </div>
              <div className="form-group">
                <input type="name" className="form-control" placeholder="Enter last name" onChange={lastNameEntered} />
              </div>
              ...
              <div className="form-group">
                <button type="button" className="signupbutton" onClick={submitInfo}>Signup</button>
              </div>
            </form>
          </div>
        </div>}
